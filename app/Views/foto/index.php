...
<div class="content-wrapper">
    ...
    <section class="content p-3">
        ...
        <div class="rounded mt-4 p-4 bg-white shadow-lg mb-5">
            ...
            <a class="mb-3 mr-2 btn btn-outline-primary" href="/foto/form" role="button">
                        ...
                        <?php foreach ($foto as $row) : ?>
                            <tr>
                                ...
                                <td class="text-nowarp">
                                    <a href="#" class="getDetail btn btn-outline-info" data-id="<?= $row->id_foto; ?>" data-toggle="modal" data-target="#getDetail">
                                        <i class="fas fa-eye pop" data-toggle="popover" data-placement="bottom" data-content="Detail"> </i>
                                    </a>
                                    <a href="/foto/form/ <?= $row->id_foto; ?>" class="btn btn-outline-warning">
                                        <i class="fas fa-edit pop" data-toggle="popover" data-placement="bottom" data-content="Update"></i>
                                    </a>
                                    <a href="/foto/hapus/ <?= $row->id_foto; ?>" class="button-delete btn btn-outline-danger">
