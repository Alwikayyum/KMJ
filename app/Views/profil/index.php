                        ...
                        <?php foreach ($profil as $row) : ?>
                            <tr>
                                ...
                                <td class="text-nowarp">
                                    <a href="/profil/akses/<?= $row->id_profil; ?>" class="btn btn-outline-success">
                                    ...
                                    <a href="/profil/hapus/<?= $row->id_profil; ?>" class="button-delete btn btn-outline-danger">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/profil" role="form" id="my-form" method="post">
                    <?= csrf_field(); ?>
