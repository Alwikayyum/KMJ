...
class SambutanSeeder extends Seeder
{
	...
	{
		$data = [
			'sambutan' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis eos repellendus voluptates unde. Corporis, labore!
		...
		$this->db->table('tabel_sambutan')->insert($data);
	}
}
